		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					...
	  					<a href="inputadmin.php"><button class="btn btn-success"><i class="glyphicon glyphicon-plus">Add</i></button></a>
		  			</div>
  					...
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
			            ...
			            <tr>
			              ...
			              <td><?php echo $var ['nama_atm']; ?></td>
			              <td><?php echo $var ['nama_rek']; ?></td>
			              <td><?php echo $var ['no_rek']; ?></td>
			              <td align="center"><?php echo "<a class='glyphicon glyphicon-edit' title='Edit' href='updateadmin.php?no=$var[no]'></a> | <a class='glyphicon glyphicon-trash' title='Hapus' href='deleteadmin.php?no=$var[no]'></a>"; ?></td>
			            </tr>
			            <?php
			            $no++;
			          	}
