		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
					...
					<li class="current"><a href="junior.php"><i class="glyphicon glyphicon-th"></i> Junior Futsal</a></li>
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Junior Futsal</div>
	  					<a href="inputjunior.php"><button class="btn btn-success"><i class="glyphicon glyphicon-plus">Add</i></button></a>
		  			</div>
  					...
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
			            ...
			            $query = mysql_query ("SELECT * FROM lap_junior");
			            $no=1;
			            ...
			            <tr>
			              ...
			              <td align="center"><?php echo "<a class='glyphicon glyphicon-trash' title='Hapus' href='deletejunior.php?no=$var[no]'></a>"; ?></td>
			            </tr>
			            <?php
			            $no++;
			          	}
