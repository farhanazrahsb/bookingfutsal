	  				...
	  				<div class="col-md-6">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title">Input Junior</div>
					        </div>
			  				<div class="panel-body">
			  					<form action="juniorproses.php" class="form-horizontal" role="form" method="post">
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">Nama Lapangan</label>
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="nama_lap" id="inputEmail3" value="Junior Futsal" readonly="readonly">
								    </div>
								  </div>
								  <div class="form-group">
