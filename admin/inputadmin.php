	  				...
	  				<div class="col-md-6">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title">Input Admin</div>
					        </div>
			  				<div class="panel-body">
			  					<form action="adminproses.php" class="form-horizontal" role="form" method="post">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="nama_atm" id="inputEmail3" placeholder="Nama ATM">
								    </div>
								  </div>
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">Nama Rekening</label>
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="nama_rek" id="inputEmail3" placeholder="Nama Rekening">
								    </div>
								  </div>
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">Nomor Rekening</label>
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="no_rek" id="inputEmail3" placeholder="Nomor Rekening">
								    </div>
								  </div>
								  <div class="form-group">
