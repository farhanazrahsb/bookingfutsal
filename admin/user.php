		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="user.php"><i class="glyphicon glyphicon-user"></i> User</a></li>
		  		...
		  		<div class="col-md-12 panel-warning">
  					...
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
			            ...
			            <tr>
			              ...
			              <td align="center"><?php echo "<a class='glyphicon glyphicon-trash' title='Hapus' href='deleteuser.php?no=$var[no]'></a>"; ?></td>
			            </tr>
			            <?php
			            $no++;
			          	}
