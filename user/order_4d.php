								...
								<ul class="nav navbar-nav cl-effect-16">
									...
									<li><a href="#" class="active" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pesan <span class="caret"></span></a>
										<ul class="dropdown-menu">
											...
											<li><a href="order_4d.php" data-hover="4D Futsal" class="active">4D Futsal</a></li>
										</ul>
									</li>
...
<div class="about">
	...
	<div class="wthree_head_section">
				<h3 class="w3l_header">4D Order</h3>
			</div>
		<div class="ab-agile">
			...
			<input type="text" class="form-control" name="nama_lap" aria-describedby="basic-addon1" value="4D Futsal" readonly="readonly"><br>
			...
			<select name="id_lap" class="selectpicker form-control" data-live-search="true" id="id_lap" onchange="changeValue(this.value)">
	                ...
	                $result = mysql_query("select * from lap_4d");    
