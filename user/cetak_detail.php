...
<div class="about">
	...
	<div class="wthree_head_section">
		...
		<div class="table-responsive">
			...
			$no=$_GET['no'];
			$query=mysql_query("SELECT * FROM order_lap WHERE no='$no'");
			...
			<td rowspan="11" align="center"><button class="btn btn-success" onClick="window.print();"><i class="fa fa-print"></i> Cetak</button></td>
			</tr>
			<tr>
			<th>Nama Lapangan</th>
